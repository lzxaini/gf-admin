			...
			<el-col :span="4" :xs="24">
				...
				<div class="head-container">
					<div class="dept-panel">
						<ul class="dept-list">
							<li v-for="item in deptList" :key="item.deptId" class="dept-item"
								:class="{ 'is-active': queryParams.deptId === item.deptId }" @click="handleDeptClick(item)">
								{{ item.deptName }}
							</li>
						...
						<div class="dept-pagination">
							...
							<el-button size="small" :disabled="deptQuery.pageNum >= deptTotalPages"
								@click="deptPageChange(1)">下一页</el-button>
						</div>
					</div>
				</div>
			</el-col>
