			...
			<el-col :span="20" :xs="24">
				...
				<el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
					...
					<el-table-column label="用户编号" align="center" key="userId" prop="userId" v-if="columns[0].visible">
						<template #default="scope"> GF{{ String(scope.row.userId).padStart(5, '0') }} </template>
					</el-table-column>
                  ...
                  :show-overflow-tooltip="true" /> -->
					...
					<el-table-column label="部门分类" align="center" prop="dept.deptType">
						<template #default="scope">
							<dict-tag :options="gf_dept_type" :value="scope.row.dept.deptType" v-if="scope.row.dept && scope.row.dept.deptName !== '游客部门'" />
					...
					<el-table-column label="白名单权限" align="center" prop="dept.deptType">
						<template #default="scope">
							<el-tag :type="scope.row.allowedWhite ? 'success' : 'danger'"> {{ scope.row.allowedWhite ? '开' : '关' }}</el-tag>
						</template>
					</el-table-column>
					<el-table-column label="充值权限" align="center" prop="dept.deptType">
						<template #default="scope">
							<el-tag :type="scope.row.allowedRecharge ? 'success' : 'danger'"> {{ scope.row.allowedRecharge ? '开' : '关' }}</el-tag>
						</template>
					</el-table-column>
					<el-table-column label="共享权限" align="center" prop="dept.deptType">
						<template #default="scope">
							<el-tag :type="scope.row.allowedShare ? 'success' : 'danger'"> {{ scope.row.allowedShare ? '开' : '关' }}</el-tag>
						</template>
					</el-table-column>
...
const { sys_normal_disable, sys_user_sex, gf_dept_type } = proxy.useDict('sys_normal_disable', 'sys_user_sex', 'gf_dept_type');
