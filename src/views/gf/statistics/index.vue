 ...
 * @LastEditTime: 2026-05-15 10:16:00
	...
	<div class="statistics-page">
		...
		<div class="metrics-grid">
			<div class="metric-card" :class="{ 'metric-warning': dashboard.remainingPoints <= 10 }">
				<div class="metric-header">
					...
					<el-icon class="metric-icon" :size="20"><Coin /></el-icon>
				</div>
			...
			<div class="metric-card">
				<div class="metric-header">
					...
					<el-icon class="metric-icon" :size="20"><Monitor /></el-icon>
				</div>
			...
			<div class="metric-card">
				<div class="metric-header">
					...
					<el-icon class="metric-icon" :size="20"><TrendCharts /></el-icon>
				</div>
				...
				<div class="metric-trend" :class="getTrendClass(dashboard.todayConsumedPointsGrowthRate)">
					<el-icon :size="14"><Top v-if="dashboard.todayConsumedPointsGrowthRate >= 0" /><Bottom v-else /></el-icon>
			...
			<div class="metric-card">
				<div class="metric-header">
					...
					<el-icon class="metric-icon" :size="20"><Wallet /></el-icon>
				</div>
				...
				<div class="metric-trend" :class="getTrendClass(dashboard.todayRechargeAmountGrowthRate)">
					<el-icon :size="14"><Top v-if="dashboard.todayRechargeAmountGrowthRate >= 0" /><Bottom v-else /></el-icon>
		...
		<div class="section-card">
			<div class="section-header">
				...
				<div>
					<el-input v-model="searchName" placeholder="搜索机构名称" clearable class="search-input" prefix-icon="Search" @clear="onSearchClear" @input="onSearchChange" />
					<el-button type="primary" class="refresh-btn" style="margin-left: 20px;" :icon="loading ? '' : 'Refresh'" :loading="loading" @click="handleRefresh" circle />
				</div>
			</div>
